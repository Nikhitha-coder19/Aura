...
Respond helpfully and concisely. Be conversational but efficient.`;
     ...
     */
    async analyzeImage(imageBase64: string, message: string): Promise<string> {
        try {
...
Provide a clear, well-structured summary.`;
     ...
     */
    async generateDraft(type: 'message' | 'email', recipient: string, context: string): Promise<string> {
